...
- Publication remains intentionally pending: branch `codex/recursive-eval-loop-publish` is pushed at `3e44ded`, draft PR #3 is open, and GitHub Actions run `31870090633` is green for the exact revision. No merge or release has been performed.

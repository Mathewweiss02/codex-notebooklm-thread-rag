...
- The timing-only post-boundary monitor has 10 eligible runs and about 2.249 observed hours; the resource-aware retrieval monitor has 3 eligible runs, 0.505 observed hours, zero failures, and zero missing-resource reports. The 168-hour soak gate is open.

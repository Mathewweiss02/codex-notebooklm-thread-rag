...
- The wall-clock release monitor is active from the protected-evidence reset
  boundary at 2026-08-15T02:44:07Z: 5 eligible runs, 0 failed or malformed
  runs, and 0.79 observed hours of the required 168. The seven-day gate is
...
- The resource-aware retrieval soak monitor now reads the protected append-only
  ...
  older reports; it currently has 5 eligible normal runs, 0.79 observed hours,

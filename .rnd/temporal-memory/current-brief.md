...
- The wall-clock release monitor is active from the protected-evidence reset
  boundary at 2026-08-15T04:46:31Z after the sync mitigation: 4 clean eligible
  runs, 0 failures, and 0.497 observed hours of the required 168. The prior
...
- The resource-aware retrieval soak monitor now reads the protected append-only
  ...
  older reports; its post-mitigation boundary currently has 4 eligible normal
  runs, 0.497 observed hours, zero failures, zero missing-step runs, and zero

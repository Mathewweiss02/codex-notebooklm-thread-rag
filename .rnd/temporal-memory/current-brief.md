...
- The wall-clock release monitor is active from the protected-evidence reset
  boundary at 2026-08-15T04:46:31Z after the sync mitigation: 5 clean eligible
  runs, 0 failures, and 0.747 observed hours of the required 168. The prior
...
- The resource-aware retrieval soak monitor now reads the protected append-only
  ...
  older reports; its post-mitigation boundary currently has 5 eligible normal
  runs, 0.747 observed hours, zero failures, zero missing-step runs, and zero
